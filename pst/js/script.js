...
window.addEventListener('load', () => {
    ...
    window.addEventListener('scroll', () => {
        ...
        if (window.scrollY > 200) {
            social.style.color = '#0070cc'
        }
        if (window.scrollY > 340) {
            divider.style.backgroundColor = '#0070cc'
        }
...
(function() {
    ...
    slideContainer.slick({
        prevArrow: '<button type="button" class="slick-prev leftt" aria-label="leftt"><img src="icons/arrow-prev.svg" alt="prev"></button>',
        nextArrow: '<button type="button" class="slick-next rightt" aria-label="rightt"><img src="icons/arrow-next.svg" alt="next"></button>',
        responsive: [
          {
            breakpoint: 768,
            settings: {
